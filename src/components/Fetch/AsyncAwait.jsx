...
const AsyncAwait = () => {
    ...
    useEffect( ()=> {
        ...
        //Esto ocurre porque el console.log se muestra antes de que se pasen los 2 segundos de retraso. 
    ...
    return (
        <div> 
            ...
            {
                //Si mi array no tiene la propiedad id puedo usar el indice como key de la siguiente manera: 
